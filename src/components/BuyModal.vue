...
watch(() => quantity.value, ()=> {
    console.log(quantity, 'in watch')
    payA.value = web3.utils.toWei(quantity.value, "ether");
})
  ...
  <ModalComponent :open="open">
      <div class="w-full md:w-[504px] md:h-[810px] bg-white py-12 px-10 rounded-md border-black border-2">
          <div class="flex justify-between items-center">
              <img src="@/assets/logo2.jpeg" class="w-1/12 text-center mx-auto md:mx-0" alt="Logo" />
              <button @click="$emit('closeModal')" class="px-3 py-1 border-black border-2 rounded-md shadow-md shadow-[#000000] text-2xl font-semibold">X</button>
          </div>
...
<!--                          <Popper placement="top" :arrow="true" hover :show="showTooltip">
              ...
              <div class="relative w-full mt-5 md:mt-0">
                  ...
                  <div class="relative rounded-xl border-2 border-black bg-white px-4 py-2 z-10 right-1.5 bottom-1.5 text-right w-[190px] h-[100px]">
                      ...
                      <p class="font-semibold text-base">{{ payA }}</p>
                  </div>
              </div>
          </div>
